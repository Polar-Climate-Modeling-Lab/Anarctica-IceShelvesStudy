...
yy = reshape(y,1,[]);
grid_in = [xx', yy'];
np_lon = -166.92; np_lat = 6.08; % we get that info from ncinfo of the file
...
xx1 = reshape(grid_out(:,1),[length(lat),length(lon)]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if length(yr) >= 38
        ...
        b99 = polyfit(yr(ind1+2:end),Intary(ind1+1:end), 1);
...
['SAVING PLOTS']
if mx == 1
    print (f1, '-r600', 'Timeseries_TmeltProb_1979_2018_HIRHAM_T3hr', '-dpng')
    print (f2, '-r600', 'PdfDist_TmeltProb_1979_2018_HIRHAM_T3hr', '-dpng')
    print (f3, '-r600', 'Corr_indices_TmeltProb_1979_2018_HIRHAM_T3hr', '-dpng')
elseif mx == 2
    print (f1, '-r600', 'Timeseries_TmeltProb_1979_2018_HIRHAM_Tmax', '-dpng')
    print (f2, '-r600', 'PdfDist_TmeltProb_1979_2018_HIRHAM_Tmax', '-dpng')
    print (f3, '-r600', 'Corr_indices_TmeltProb_1979_2018_HIRHAM_Tmax', '-dpng')
end  %  
